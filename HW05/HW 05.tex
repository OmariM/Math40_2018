...
\assignment{HW05 - Subspaces and Determinants }
\duedate{February 16, 2018 }

\begin{document}
\section*{}
\problemlist{Section 3.5 Numbers: 8, 17, 42, 48, 58, 66b \\ Section 3.6 Numbers: 4, 8, 12, 16, 32, 44, 50 \\ Section 4.2: 8}
...
\begin{problem}[3.6.16]
    \textit{Show that the transformation from $\mathbb{R}^2$ to $\mathbb{R}^2$ is linear by showing that it is a matrix transformation:}
    	 ...
    	 \centering{$R$ rotates a vector $45^{\circ}$ counterclockwise about the origin.}
\end{problem}
